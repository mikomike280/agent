                    ...
                    <div className="flex-1 overflow-y-auto space-y-2">
                        {conversations.length === 0 ? (
                            <div className="text-center py-12">
                                <MessageSquare className="w-12 h-12 text-[var(--text-secondary)] mx-auto mb-4 opacity-50" />
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full p-4 rounded-xl text-left transition-all ${isSelected
                                                ...
                                                : 'bg-[var(--bg-input)] hover:bg-[var(--bg-input)]/70 border-2 border-transparent'
                                            }`}
                                    >
                ...
                {selectedConversation ? (
                    ...
                    <Card className="h-full flex items-center justify-center">
                        <div className="text-center">
                            <MessageSquare className="w-16 h-16 text-[var(--text-secondary)] mx-auto mb-4 opacity-30" />
